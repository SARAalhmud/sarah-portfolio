...
const certs = [
 ...
 {
  title: "شهادة Million Arab Coders",
  issuer: "مبادرة مليون مبرمج عربي - دبي",
  description:
    "إتمام برنامج تدريبي متخصص في تطوير البرمجيات واكتساب مهارات عملية في البرمجة والتقنيات الحديثة.",
},
  {
